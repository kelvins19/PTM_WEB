        ...
        <div class="col-md-12">
            <form>
                ...
                <div class="form-group col-md-6">
                    ...
                    <a href="{{ route('admin.merk') }}" class="btn btn-outline-primary">Reset filter</a>
                </div>
                <div class="form-group col-md-6">
                    <a href="{{ route('admin.merk.add') }}" class="btn btn-outline-success">Add Merk</a>
                </div>
            </form>
            <table class="table">
                <thead>
                ...
                @if (!empty($merks))
                    @forelse($merks as $merk)
                        <tr>
                            ...
                            <td><a href="{{ route('admin.merk.edit', $merk->id) }}">Edit</a></td>
                            <td><a href="{{ route('admin.merk.delete', $merk->id) }}">Delete</a></td>
                        </tr>
                    @empty
                        <tr>
